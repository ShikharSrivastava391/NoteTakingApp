...
Please ensure NoteMakingApp is running and the API server is accessible.`}]}}}async function _s(t){try{let e=await Pn();return e.currentWorkspace=t,e.lastUpdated=new Date().toISOString(),await ql(e),{content:[{type:"text",text:`\u2705 Workspace context set to:
\u{1F4C1} **${t}**
...
`):"No bases found in this workspace"}`}]}}catch{return{content:[{type:"text",text:"Bases feature not configured in this workspace"}]}}}async function qm(t,e){let r=(0,Ge.join)(t,".NoteMakingApp","bases",`${e}.json`);try{let a=await(0,ae.readFile)(r,"utf-8"),o=JSON.parse(a);return{content:[{type:"text",text:`**Base: ${e}**
...
`):"No canvases found"}`}]}}catch{return{content:[{type:"text",text:"Canvas feature not configured in this workspace"}]}}}async function Ym(t,e){let r=(0,kt.join)(t,".NoteMakingApp","canvas",`${e}.json`);try{let a=await(0,Te.readFile)(r,"utf-8"),o=JSON.parse(a),i=o.shapes||[],c=i.filter(f=>f.type==="arrow"||f.type==="line"),u=i.filter(f=>f.type!=="arrow"&&f.type!=="line");return{content:[{type:"text",text:`**Canvas: ${o.name||e}**
...
Total connections: ${i.length}`}]}}catch(a){return{content:[{type:"text",text:`\u274C Failed to get connections: ${a.message}`}]}}}async function eg(t,{canvasId:e,format:r="markdown"}){let a=(0,kt.join)(t,".NoteMakingApp","canvas",`${e}.json`);try{let o=await(0,Te.readFile)(a,"utf-8"),i=JSON.parse(o),c="";switch(r){case"markdown":c=`# ${i.name||e}
...
`):"No kanban boards found"}`}]}}catch{return{content:[{type:"text",text:"Kanban feature not configured in this workspace"}]}}}async function rg(t,e){let r=(0,at.join)(t,".NoteMakingApp","kanban",`${e}.json`);try{let a=await(0,ie.readFile)(r,"utf-8"),o=JSON.parse(a),i=`**Kanban Board: ${o.name||e}**
...
`}]}}function wb(){return{contents:[{uri:"NoteMakingApp://markdown-syntax/callouts",mimeType:"text/markdown",text:`# Callout/Admonition Syntax
...
\u2705 **Correct:**
- \`>[!note]\` - Proper syntax
`}]}}function _b(){return{contents:[{uri:"NoteMakingApp://markdown-syntax/images",mimeType:"text/markdown",text:`# Image Embedding Syntax
...
`}]}}function Sb(){return{contents:[{uri:"NoteMakingApp://markdown-syntax/wiki-links",mimeType:"text/markdown",text:`# Wiki Link Syntax
...
`}]}}function kb(){return{contents:[{uri:"NoteMakingApp://markdown-syntax/math",mimeType:"text/markdown",text:`# Math Equations (LaTeX/KaTeX)
...
`}]}}function xb(){return{contents:[{uri:"NoteMakingApp://markdown-syntax/tables",mimeType:"text/markdown",text:`# Markdown Tables
...
4. [ ] Deployment
\`\`\`
`}]}}function Cb(){return{contents:[{uri:"NoteMakingApp://markdown-syntax/formatting",mimeType:"text/markdown",text:`# Text Formatting
...
`}]}}function Rb(){return{contents:[{uri:"NoteMakingApp://markdown-syntax/diagrams",mimeType:"text/markdown",text:`# Mermaid Diagrams
